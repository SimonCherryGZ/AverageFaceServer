...
public class UploadFileServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (FileUpload.isMultipartContent(requestContext)) {
			...
			factory.setRepository(new File("D:/Simon/Works/Web/webapps/webapps/AverageFaceServer/tmp/"));
			...
			while (it.hasNext()) {
				...
				if (fileItem.isFormField()) {
					...
					if(fileItem.getFieldName().equals("folder")){
						uploadfolder = new String(fileItem.getString().getBytes(
								"iso8859-1"), "gbk");
					}
...
//								+ fullFile.getName());
						...
						if(uploadfolder.length()>0 && !uploadfolder.equals("root")){
							filepath = "D:/Simon/Works/Web/webapps/webapps/AverageFaceServer/faceset/"
									+ uploadfolder + "/";
						}
